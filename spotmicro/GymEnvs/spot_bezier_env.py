...
class spotBezierEnv(spotGymEnv):
  ...
  """
    ...
    def step(self, action):
        #Adapté en enlevant le calcul de la reward et de l'observation
    ...
    """
        ...
        action = self._transform_action_to_motor_command(action) #Not here too
        self.spot.Step(action) #Bug not here
